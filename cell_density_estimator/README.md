[![Binder](http://mybinder.org/badge.svg)](http://mybinder.org/repo/fomightez/methods_in_yeast_genetics/cell_density_estimator/cell_density_estimator_for_single_sample.ipynb)  
^^^^^^^^^^  
