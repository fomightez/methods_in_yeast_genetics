[![Binder](http://mybinder.org/badge.svg)](http://mybinder.org/repo/fomightez/methods_in_yeast_genetics/notebooks/yeast_growth_planner/yeast%20growth%20planner.ipynb)  
^^^^^^^^^^  
